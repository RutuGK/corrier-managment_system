...
<body>
    <h1 align='center' style="margin: 15px; color:#273c75;font-weight: bold;font-family:'Times New Roman', Times, serif">Access Restoration</h1><hr/>
    <h3 align='center' style="font-weight: bold;color:#006bb3;font-family:'Times New Roman', Times, serif">The Fastest Courier Service Ever</h3>
        ...
        <div class="container" style="margin-top: 60px; width:50%;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p style="color:#006bb3;">To Reset Your Password</p>
                    <form action="resetpswd.php" method="get">
                        ...
                        <p style="color: #006bb3;">Don't have an account?⮞➤ <a href="register.php">Register here</a>.</p>
