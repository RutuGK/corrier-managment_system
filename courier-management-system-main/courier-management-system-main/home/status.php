...
<?php include('header.php');
    ...
    if($stdate==$tddate){
        ?>
        <h1 style="margin: 100px;background-color:#007399;color:white;text-align:center">Status >> On The Way...</h1>
        <br/><hr/>
        <div align='center'>
        <button onclick="window.location.href='trackMenu.php'" style="background-color:#b3ecff;height:60px;width:130px;border-radius:15px;cursor:pointer">GoBack</button>
        </div>
         <?php 
    }
    else{
