    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:#adc2eb; width: 140px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr>
                    <td colspan="4">____________________________________________________________________________________</td>
                ...
                <tr>
                    ...
                    <td>Items Image:</td>
                    <td><input type="file" name="simg" ><br></td>
                </tr>
                <br>
                <tr>
