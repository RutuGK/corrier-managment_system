...
<div style="overflow-x:auto;">
    <table border="0px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 5px 15px;">
        <th colspan="4" style="text-align: center;background-color:#adc2e0; width: 140px; height: 50px;">Update The Details As Required</th>
        <tr>
        ...
        <tr><td colspan="4">___________________________________________________________________</td></tr>
        <tr>
